...
from lms.djangoapps.courseware.views.views import check_and_get_upgrade_link, get_cosmetic_display_price
...
class CourseOutlineFragmentView(EdxFragmentView):
    ...
    def render_to_fragment(self, request, course_id=None, page_context=None, **kwargs):
        ...
        context = {
            ...
            'upgrade_price': get_cosmetic_display_price(course_overview),
        }
