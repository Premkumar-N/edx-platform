...
def delete_course(course_key, user_id, keep_instructors=False):
    ...
    if not keep_instructors:
        _remove_user_and_groups_permission_from_course(course_key)
...
def _remove_user_and_groups_permission_from_course(course_key):
    """
    In the django layer, remove all the user permissions groups associated with this course
    """
